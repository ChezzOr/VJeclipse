...
public class Menu {
    ...
    public void guardarPartida(Graphics g){
        ...
        g.setColor(Color.BLACK);
        g.drawString("Â¿Guardar partida?", 253, 278);
        g.drawString("SÃ­", 303, 353);
        g.drawString("No", 453, 353);
        
        g.setColor(Color.WHITE);
        g.drawString("Â¿Guardar partida?", 250, 275);
    ...
    // Experiencia, nivel, vida, magia, cuÃ¡nto le falta de experiencia para el siguiente nivel.
